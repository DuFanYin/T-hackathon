#!/usr/bin/env python3
"""
Engine-direct manual test for `strategy_JH`.

Creates `MainEngine` in mock mode, initializes `strategy_JH`, then manually
...
# JH default universe includes APTUSDT; open one market position.
OPEN_SYMBOL: str = "APTUSDT"
OPEN_QTY: float = 5.0
ORDER_TYPE: str = "MARKET"

WAIT_FOR_FILL_SECONDS: int = 60
POLL_INTERVAL_SECONDS: int = 2
PROMPT_BEFORE_OPEN: bool = True
